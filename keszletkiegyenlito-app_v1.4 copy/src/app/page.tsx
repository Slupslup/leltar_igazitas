...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start p-4 md:p-8 lg:p-12 bg-gray-50">
      ...
      {/* Transfer Form */}
      <div className="w-full max-w-6xl mb-8 p-6 bg-white rounded-lg shadow sticky bottom-0 z-50 border-t border-gray-200" style={{background: 'rgba(255,255,255,0.97)'}}>
        <h2 className="text-xl font-semibold mb-4 text-gray-700">
